#ifndef ECHARTLINES_H
#define ECHARTLINES_H
...
//![1]
class EChartLines : public QChart
//![1]
{
public:
    explicit EChartLines(QGraphicsItem *parent = nullptr, Qt::WindowFlags wFlags = {});
    ~EChartLines();
    ...
    void setSplines(QLineSeries* line, int i);
    ...
    void init(Parameter parameter,QLineSeries* lines , QWidget *widget);
    void init(Parameter parameter,QList<QLineSeries*> lines , QWidget *widget);
...
private:
    ...
    QList<QLineSeries*> m_spline;
    QLineSeries *m_splineHelp;
