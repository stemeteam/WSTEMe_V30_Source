#include "edev_sen0112.h"

EDev_Sen0112::EDev_Sen0112()
{
    this->setMaxREG(0x4B);
...
QString EDev_Sen0112::sensorUnitText()
{
    QString _res="";
    switch(m_sensorUnit){
    case SSU_default:_res = "(lx)";
        break;
    case SSU_Lux:_res="(lx)";
        break;
    }
    return _res;
}
...
void EDev_Sen0112::setMode(quint16 value)
{
    writeSingleREG(ESensor_Base::dREG_MOTOR_CONTROL,value);
}

void EDev_Sen0112::setZero(QVector<quint16> values)
{
    writeMultipleREG(ESensor_Base::dREG_SEN01_ZERO,values);
}


double EDev_Sen0112::sensorConvertUnits(double value)
{
    double _res;
    switch(m_sensorUnit){
    case SSU_default:_res = value;this->setResolution(0);
        break;
    case SSU_Lux:_res = value;this->setResolution(0);
        break;
    }
    return _res;
}

void EDev_Sen0112::calculatorValue()
{
    //Units convert
    updateDataPoll();
...
void EDev_Sen0112::calculatorValueCalib()
{
...
EDev_Sen0112::EData EDev_Sen0112::getDataRaw(bool *ok)
{
    EData data;
    int head,tail;
...
void EDev_Sen0112::setDataRaw(EData data)
{
...
void EDev_Sen0112::clearDataRaw()
{
m_DATA_RAW_HEAD = m_DATA_RAW_TAIL;
}

void EDev_Sen0112::updateDataPoll()
{
...
void EDev_Sen0112::getValueBuff()
{
    double _val=0,_sum=0,_time=0,_lineTime=0;
    int _index = QVariant(this->REG_Read(dREG_SEN01_INDEX)).toInt();
