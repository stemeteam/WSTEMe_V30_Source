#ifndef SENSOR_SEN0109_H
#define SENSOR_SEN0109_H
...
#include <esensor/edev_sen0109.h>
#include <vlogin/vuser.h>
#include <vchart/vchart_zoom.h>
#include <vroot/vdevicecalibration.h>

namespace Ui {
class Sensor_SEN0109;
}

class Sensor_SEN0109 : public QWidget
{
    Q_OBJECT
    /////////////////////////////////////////////////////////////////////////////////////////////////Function for Sensor...
 public:
 ...
 private:
     ...
     EDev_Sen0109 *m_edev_sen0109=nullptr;
 ...
 private:
     ...
     void displayPoll();
 public:
     explicit Sensor_SEN0109(QWidget *parent = nullptr);
     ~Sensor_SEN0109();
 private slots:
