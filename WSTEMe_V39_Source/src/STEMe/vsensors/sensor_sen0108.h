#ifndef SENSOR_SEN0108_H
#define SENSOR_SEN0108_H
...
#include <esensor/edev_sen0108.h>
...
namespace Ui {
class Sensor_SEN0108;
}

class Sensor_SEN0108 : public QWidget
{
    Q_OBJECT
 ...
 private:
     ...
     EDev_Sen0108 *m_edev_sen0108=nullptr;
 ...
 private:
     ...
     void displayPoll();
 public:
     explicit Sensor_SEN0108(QWidget *parent = nullptr);
     ~Sensor_SEN0108();
 private slots:
