#ifndef SENSOR_SEN0150_H
#define SENSOR_SEN0150_H
...
#include <esensor/edev_sen0150.h>
...
namespace Ui {
class Sensor_SEN0150;
}

class Sensor_SEN0150 : public QWidget
{
    Q_OBJECT
...
private:
        ...
        EDev_Sen0150 *m_edev_sen0150=nullptr;
...
public:
    explicit Sensor_SEN0150(QWidget *parent = nullptr);
    ~Sensor_SEN0150();
