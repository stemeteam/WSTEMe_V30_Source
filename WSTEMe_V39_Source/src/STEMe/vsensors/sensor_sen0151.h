#ifndef SENSOR_SEN0151_H
#define SENSOR_SEN0151_H
...
#include <esensor/edev_sen0151.h>
...
namespace Ui {
class Sensor_SEN0151;
}

class Sensor_SEN0151 : public QWidget
{
    Q_OBJECT
...
private:
        ...
        EDev_Sen0151 *m_edev_sen0151=nullptr;
...
public:
    explicit Sensor_SEN0151(QWidget *parent = nullptr);
    ~Sensor_SEN0151();
...
private:
    Ui::Sensor_SEN0151 *ui;
    quint32 m_system_count=0;
    double m_current_ampe=0;
