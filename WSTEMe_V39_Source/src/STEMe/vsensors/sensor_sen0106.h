#ifndef SENSOR_SEN0106_H
#define SENSOR_SEN0106_H
...
#include <esensor/edev_sen0106.h>
...
namespace Ui {
class Sensor_SEN0106;
}

class Sensor_SEN0106 : public QWidget
{
    Q_OBJECT
...
private:
        ...
        EDev_Sen0106 *m_edev_sen0106=nullptr;
...
public:
    explicit Sensor_SEN0106(QWidget *parent = nullptr);
    ~Sensor_SEN0106();
private slots:
...
private:
    Ui::Sensor_SEN0106 *ui;
    bool    m_deviceModbusConnect=false;
    Vchart_Zoom *m_vchartZoom = nullptr;
    VUser m_user;

    void setPhColor(double pH);

};

#endif // SENSOR_SEN0106_H
