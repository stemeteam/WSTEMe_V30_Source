#ifndef SENSOR_SEN0104_H
#define SENSOR_SEN0104_H
...
#include <esensor/edev_sen0104.h>
...
namespace Ui {
class Sensor_SEN0104;
}

class Sensor_SEN0104 : public QWidget
{
    Q_OBJECT
        /////////////////////////////////////////////////////////////////////////////////////////////////Function for Sensor...
public:
...
private:
        ...
        EDev_Sen0104 *m_edev_sen0104=nullptr;
...
public:
    explicit Sensor_SEN0104(QWidget *parent = nullptr);
    ~Sensor_SEN0104();
private slots:


        void on_comboBox_Value_Unit_currentIndexChanged(int index);
