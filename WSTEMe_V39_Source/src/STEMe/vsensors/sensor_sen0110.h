#ifndef SENSOR_SEN0110_H
#define SENSOR_SEN0110_H
...
#include <esensor/edev_sen0110.h>
#include <vlogin/vuser.h>
#include <vchart/vchart_zoom.h>
#include <vroot/vdevicecalibration.h>

namespace Ui {
class Sensor_SEN0110;
}

class Sensor_SEN0110 : public QWidget
{
    Q_OBJECT
    /////////////////////////////////////////////////////////////////////////////////////////////////Function for Sensor...
public:
...
private:
    ...
    EDev_Sen0110 *m_edev_sen0110=nullptr;
...
private:
    ...
    void displayPoll();
public:
    explicit Sensor_SEN0110(QWidget *parent = nullptr);
    ~Sensor_SEN0110();
private slots:
