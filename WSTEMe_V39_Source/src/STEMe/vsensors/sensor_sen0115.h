#ifndef SENSOR_SEN0115_H
#define SENSOR_SEN0115_H
...
#include <esensor/edev_sen0115.h>
...
namespace Ui {
class Sensor_SEN0115;
}

class Sensor_SEN0115 : public QWidget
{
    Q_OBJECT
    /////////////////////////////////////////////////////////////////////////////////////////////////Function for Sensor...
 public:
 ...
 private:
     ...
     EDev_Sen0115 *m_edev_sen0115=nullptr;
 ...
 private:
     ...
     void displayPoll();
 public:
     explicit Sensor_SEN0115(QWidget *parent = nullptr);
     ~Sensor_SEN0115();
 private slots:
